...
import { ArrowLeft, Users, MessageSquare, Globe, Lock } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardHeader } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { Skeleton } from "@/components/ui/skeleton";
import { AspectRatio } from "@/components/ui/aspect-ratio";
import { getGroupDetailsPreview } from "@/lib/api/customer/groups";
...
export default function DiscoverGroupDetailsPage() {
  ...
  const {
    ...
    queryFn: () => getGroupDetailsPreview(groupId),
    enabled: !!groupId,
  });
  ...
  const getPrivacyLabel = (privacy: EnumGroupPrivacy) => {
    switch (privacy) {
      case EnumGroupPrivacy.Private:
        return "Riêng tư";
      case EnumGroupPrivacy.Public:
        return "Công khai";
      default:
        return privacy;
    }
  ...
  const getPrivacyIcon = (privacy: EnumGroupPrivacy) => {
    switch (privacy) {
      case EnumGroupPrivacy.Private:
        ...
        <CardHeader className="p-0 relative">
          ...
          <div className="absolute top-3 right-3">
            ...
            >
              ...
              <span className="ml-1">{getPrivacyLabel(group.privacy)}</span>
            </Badge>
          </div>
        </CardHeader>
